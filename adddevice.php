...
<link rel="stylesheet" href="includes/validation.css" type="text/css" media="screen" />
			...
			<div class="left" id="main-left">
				...
				<div class="post">
					<div class="post-body">
                 <div class="section-title"><center>Add System Equipment</center></div>
<?php if ($errormsg !="")
		{
		?> 
		<table   >
...
<?php } ?>
                         ...
                         <td   >
                          <div>  
                            <input type="text" size="30"  name="deviceNum" id="deviceNum" class="text" value=""/><span id='deviceNumInfo'></span><span id="msgbox" style="display:none" ></span></div>
                                      ...
                                      <tr>
              	<td style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2"><span class="mandatory">*</span>Device Type:</td>
              	<td>
              		<?php
		   		$groupquery = "SELECT ID,description FROM  equipments";
				$result = mysql_query($groupquery) or die('Error, query failed'); 
			   echo "<select name='type' id='type' style='width:178px';>\n";
			  echo " <option value=''> Select Device Type</option>";
		  	...
		  	?>
			                         ...
			                         <tr  >
   							<td style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2"><span class="mandatory">*</span>County</td>
   							<td  ><div><?php
		   		$groupquery = "SELECT ID,name FROM countys ORDER BY name ASC";
				$result = mysql_query($groupquery) or die('Error, query failed'); 
		  	...
		  	?><span id='locationInfo'></span></div></td>
                         ...
                         <tr  >
   							<td style="font-family:Georgia, 'Times New Roman', Times, serif ;background-color: #F2F2F2"><span class="mandatory">*</span>Facility</td>
   							<td  ><div><?php
		   		$groupquery = "SELECT AutoID,name FROM facility where level=0 ORDER BY name ASC";
				$result = mysql_query($groupquery) or die('Error, query failed'); 
			   echo "<select name='location' id='location' style='width:178px';>\n";
            ...
            <td><input type="text" name="location1" id="location1" size="30"  class="text" /><span id='location1Info'></span><span id="msgbox" style="display:none" ></span></div>
  						 ...
  						 <tr>
    							 <th colspan="2">  
								 <div align="center">
				 <input name="saveonly" id="saveonly" type="submit" class="button" value="Save Equipment" />
		  	    <input name="saveadd" id="saveadd" type="submit" class="button" value="Save & Add Equipment" />
