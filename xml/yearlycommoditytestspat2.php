...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$totaltests=totalequiptests350_1($partnerid,$filter,$startmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate,$level,$mfl);
...
<dataset seriesName='Calibur' color='F6BD0F' >
<?php   
...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$totaltests=totalcaliburtests350_1($partnerid,$filter,$startmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate,$level,$mfl);
...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$totaltests=totalpima350_1($partnerid,$filter,$startmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate,$level,$mfl);
