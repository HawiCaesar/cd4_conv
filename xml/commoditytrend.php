...
<dataset seriesName='Adult Tests' color='F6BD0F' >
 ...
 $currentyear=$_GET['mwaka'];
		...
		$totalerrors=totaladults($partnerid,$filter,$startmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate,$level,$mfl);
?>
...
<dataset seriesName='Paediatric Tests' color='FF0080' >
 ...
 $currentyear=$_GET['mwaka'];
		...
		$totalerrors=totalchildren($partnerid,$filter,$startmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate,$level,$mfl);
?>
