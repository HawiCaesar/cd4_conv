...
<?php
$sql=mysql_query("select errorID,errorName from error") or die(mysql_error());
while(list($errorID,$errorName)=mysql_fetch_array($sql))
{

$totalerrors=totalerrorbycategory($errorID,$partnerid,$filter,$currentmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate);
?>
