...
function centralfacilityspercounty2($county,$sql){
   $sql="SELECT count(*) FROM  `exp_file_data` e, facilitycounty f WHERE e.`SITE` = f.`MFLCode` AND e.SITE <>0 AND f.countyID='$county'".$sql;
