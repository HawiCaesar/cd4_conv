...
<dataset seriesName='Device 1' color='1D8BD1' anchorBorderColor='1D8BD1' anchorBgColor='1D8BD1'>
<?php   
...
<dataset seriesName='Device 2' color='F1683C' anchorBorderColor='F1683C' anchorBgColor='F1683C'>
	<?php   $startmonth =  1; 
 $endmonth =  12; 
 $currentyear=$_GET['mwaka'];
		for ( $startmonth;  $startmonth<=$endmonth;  $startmonth++)
...
<dataset seriesName='Device 3' color='334433' anchorBorderColor='334433' anchorBgColor='334433'>
	<?php   $startmonth =  1; 
 $endmonth =  12; 
 $currentyear=$_GET['mwaka'];
		for ( $startmonth;  $startmonth<=$endmonth;  $startmonth++)
