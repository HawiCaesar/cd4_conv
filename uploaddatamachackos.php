 ...
 while(!feof($file))
  {
      ...
      if($test==0){
         // fgets($file);
		  ...
		  $temp_str=trim(str_replace("\"","",$data_array[12]));
		...
		if(count($data_array)>17){
		 $data1=str_split($data_array[17],14);
		...
		echo "<th colspan='1'>".$data_array[17]."</th></tr>
		</thead>
		<tbody>
		";		
		}
		...
		$checker=false;
		$data_to_insert="";
		for($i=17;$i<count($data_array)-1; $i+=17){
			if($i==17){
...
,SampleName,SampleID,CaseNumber,AGE,SEX,SITE,Date_Analyzed,CD3CD4CD45TruCCD3Lymph,CD3CD4CD45TruCCD3AbsCnt,CD3CD4CD45TruCCD3CD4Lymph,CD3CD4CD45TruCCD3CD4AbsCnt,CD3CD4CD45TruCCD45AbsCnt) values (".substr($data_to_insert,0,-1).") ON DUPLICATE KEY UPDATE SampleID=SampleID ";
...
if (isset($_POST['submit_1']))
{
  ...
  header("location:uploaddatamachackos.php");
  exit;
                 ...
                 <div class="clonable form"> 
                   ...
                   <table width="200" border="1">
                              <tr>
                                ...
                                ?>
                              &nbsp;
                                <input type="reset" name="cancel"  id="cancel_1" onClick="location.href='uploaddatamachackos.php'" value="Reload page" class="button" />
                               &nbsp;</p> 
                   ...
                   <table width="100%" border="1">
                              <tr>
                               ...
                               &nbsp;
                                ...
                                <input type="reset" name="cancel"  id="cancel_1" onClick="location.href='uploaddatamachackos.php'" value="Cancel and Reupload" class="button" />
                                &nbsp;</p>
